...
def calculate_metrics(y_true, y_pred):
    ...
    y_true = y_true > 0.5           # Threshold value
...
if __name__ == '__main__':
    ...
    for i, (x, y) in tqdm(enumerate(zip(test_x, test_y)), total=len(test_x)):
        ...
        x = np.expand_dims(x, axis=0)                       # (1, 3, 512, 512) - create a batch of one image
        ...
        y = y / 255.0                                       # pixel normalization
        y = np.expand_dims(y, axis=0)                       # (1, 1, 512, 512) - create a batch of one image
